...
NUMBER_FIELDS = {
    ...
    "miniPlayerBottomOffsetDp": (0.0, 20.0),
...
DEFAULT_STATE = {
    "variant": "oled_instrument",
    "accentOpacity": 0.42,
    "glowOpacity": 0.30,
    "vignetteOpacity": 0.62,
    "blackFalloffOpacity": 0.88,
    "primaryTextLuminance": 0.77,
    "secondaryTextLuminance": 0.44,
    "typeface": "system",
    "homeHeadingSizeSp": 23.5,
    "headingWeight": 650,
    "cardTitleSizeSp": 15.5,
    "ratingSizeDp": 22.0,
    "ratingRadiusDp": 7.0,
    "ratingBlackOpacity": 0.78,
    "ratingAccentOpacity": 0.18,
    "ratingOutlineOpacity": 0.14,
    "ratingTintSource": "presentation",
    "miniPlayerOpacity": 0.92,
...
ADB_EXTRAS = {
    ...
    "miniPlayerBottomOffsetDp": "mini_bottom_offset",
